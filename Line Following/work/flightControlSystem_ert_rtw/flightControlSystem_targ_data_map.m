    ...
    ;%***********************
        ...
        ;%
            ...
            section.data(3)  = dumData; %prealloc
                    ...
                    ;% dexojrsdjj.Gain6_Gain
                    section.data(1).logicalSrcIdx = 1;
                    section.data(1).dtTransOffset = 0;

                    ;% dexojrsdjj.Gain7_Gain
            ...
            section.data(6)  = dumData; %prealloc
                    ...
                    ;% dexojrsdjj.Gain5_Gain
                    section.data(1).logicalSrcIdx = 4;
                    section.data(1).dtTransOffset = 0;

                    ;% dexojrsdjj.Gain3_Gain
            ...
            section.data(10)  = dumData; %prealloc
                    ...
                    ;% dexojrsdjj.fxgka2mnesn.SliderGain1_gain
                    section.data(7).logicalSrcIdx = 16;
                    section.data(7).dtTransOffset = 6;

                    ;% dexojrsdjj.fxgka2mnesn.SliderGain_gain
                    section.data(8).logicalSrcIdx = 17;
                    section.data(8).dtTransOffset = 7;

                    ;% dexojrsdjj.fxgka2mnesn.SliderGain2_gain
                    section.data(9).logicalSrcIdx = 18;
                    section.data(9).dtTransOffset = 8;

                    ;% dexojrsdjj.fxgka2mnesn.SliderGain3_gain
            ...
            section.data(42)  = dumData; %prealloc
                    ...
                    ;% dexojrsdjj.fxgka2mnesn.Constant_Value_fpldg45inv
    ...
    ;%**************************
        ...
        ;%
            ...
            section.data(19)  = dumData; %prealloc
                    ...
                    ;% ntrh2fpvwnc.h1mvagpjp4
                    section.data(2).logicalSrcIdx = 1;
                    section.data(2).dtTransOffset = 8;

                    ;% ntrh2fpvwnc.l2td5wq5te
                    section.data(3).logicalSrcIdx = 2;
                    section.data(3).dtTransOffset = 882;

                    ;% ntrh2fpvwnc.ghllflln1h
                    section.data(4).logicalSrcIdx = 3;
                    section.data(4).dtTransOffset = 913;

                    ;% ntrh2fpvwnc.cy1e4edrnp
                    section.data(5).logicalSrcIdx = 4;
                    section.data(5).dtTransOffset = 944;

                    ;% ntrh2fpvwnc.gtffandrxa
                    section.data(6).logicalSrcIdx = 5;
                    section.data(6).dtTransOffset = 970;

                    ;% ntrh2fpvwnc.l1wwdpxi3b
                    section.data(7).logicalSrcIdx = 6;
                    section.data(7).dtTransOffset = 1001;

                    ;% ntrh2fpvwnc.hco0325ctn
                    section.data(8).logicalSrcIdx = 7;
                    section.data(8).dtTransOffset = 1032;

                    ;% ntrh2fpvwnc.pqzkkmrkuj
                    section.data(9).logicalSrcIdx = 8;
                    section.data(9).dtTransOffset = 1906;

                    ;% ntrh2fpvwnc.lxr31gabbg
                    section.data(10).logicalSrcIdx = 9;
                    section.data(10).dtTransOffset = 1931;

                    ;% ntrh2fpvwnc.eyy3unz2d5
                    section.data(11).logicalSrcIdx = 10;
                    section.data(11).dtTransOffset = 2334;

                    ;% ntrh2fpvwnc.es0pi03vgx
                    section.data(12).logicalSrcIdx = 11;
                    section.data(12).dtTransOffset = 2335;

                    ;% ntrh2fpvwnc.mrcrdp5pyo
                    section.data(13).logicalSrcIdx = 12;
                    section.data(13).dtTransOffset = 2336;

                    ;% ntrh2fpvwnc.kmv3wcjd0i
                    section.data(14).logicalSrcIdx = 13;
                    section.data(14).dtTransOffset = 2337;

                    ;% ntrh2fpvwnc.fsnaqk4ohv
                    section.data(15).logicalSrcIdx = 14;
                    section.data(15).dtTransOffset = 2338;

                    ;% ntrh2fpvwnc.bht21mxm3z
                    section.data(16).logicalSrcIdx = 15;
                    section.data(16).dtTransOffset = 2339;

                    ;% ntrh2fpvwnc.jevwwv1wwr
                    section.data(17).logicalSrcIdx = 16;
                    section.data(17).dtTransOffset = 2340;

                    ;% ntrh2fpvwnc.ehjp5nh2wc
                    section.data(18).logicalSrcIdx = 17;
                    section.data(18).dtTransOffset = 2341;

                    ;% ntrh2fpvwnc.i1x0yao0zq
                    section.data(19).logicalSrcIdx = 18;
                    section.data(19).dtTransOffset = 2342;
            ...
            section.data(8)  = dumData; %prealloc
                    ...
                    ;% ntrh2fpvwnc.fxgka2mnesn.nrefbwfnlj
                    section.data(5).logicalSrcIdx = 29;
                    section.data(5).dtTransOffset = 8;

                    ;% ntrh2fpvwnc.fxgka2mnesn.ceroicttyd
                    section.data(6).logicalSrcIdx = 30;
                    section.data(6).dtTransOffset = 9;

                    ;% ntrh2fpvwnc.fxgka2mnesn.owpl403lw5
                    section.data(7).logicalSrcIdx = 31;
                    section.data(7).dtTransOffset = 10;

                    ;% ntrh2fpvwnc.fxgka2mnesn.nu40ng55ji
    ...
    ;%*******************
        ...
        ;%
            ...
            section.data(3)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fnl2fshocp
                    section.data(1).logicalSrcIdx = 1;
                    section.data(1).dtTransOffset = 0;

                    ;% cjyyyt0pe2y.d5a0224qhi
                    section.data(2).logicalSrcIdx = 2;
                    section.data(2).dtTransOffset = 1;

                    ;% cjyyyt0pe2y.ezpwhg03ur
                    section.data(3).logicalSrcIdx = 3;
                    section.data(3).dtTransOffset = 2;
            ...
            section.data(4)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.a4nodvwqau
                    section.data(3).logicalSrcIdx = 8;
                    section.data(3).dtTransOffset = 2;

                    ;% cjyyyt0pe2y.ce4tnbcvjd
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.m3pa0s0flj
                    section.data(1).logicalSrcIdx = 10;
                    section.data(1).dtTransOffset = 0;

                    ;% cjyyyt0pe2y.fxgka2mnesn.ajg23qky12
                    section.data(2).logicalSrcIdx = 11;
                    section.data(2).dtTransOffset = 1;
            ...
            section.data(10)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.dvr2emqcc4
                    section.data(5).logicalSrcIdx = 17;
                    section.data(5).dtTransOffset = 7;

                    ;% cjyyyt0pe2y.fxgka2mnesn.kxxzbv0xi1
                    section.data(6).logicalSrcIdx = 18;
                    section.data(6).dtTransOffset = 8;

                    ;% cjyyyt0pe2y.fxgka2mnesn.ole4hvowrf
                    section.data(7).logicalSrcIdx = 19;
                    section.data(7).dtTransOffset = 9;

                    ;% cjyyyt0pe2y.fxgka2mnesn.fbvgjtqjq4
                    section.data(8).logicalSrcIdx = 20;
                    section.data(8).dtTransOffset = 10;

                    ;% cjyyyt0pe2y.fxgka2mnesn.llkah3tahv
                    section.data(9).logicalSrcIdx = 21;
                    section.data(9).dtTransOffset = 11;

                    ;% cjyyyt0pe2y.fxgka2mnesn.obiisosnex
            ...
            section.data(4)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.geo3jx2tjc
            ...
            section.data(26)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.oupd4rsi3a
                    section.data(7).logicalSrcIdx = 74;
                    section.data(7).dtTransOffset = 6;

                    ;% cjyyyt0pe2y.fxgka2mnesn.cb4mho5yin
                    section.data(8).logicalSrcIdx = 75;
                    section.data(8).dtTransOffset = 7;

                    ;% cjyyyt0pe2y.fxgka2mnesn.b5tfaayzx5
                    section.data(9).logicalSrcIdx = 76;
                    section.data(9).dtTransOffset = 8;

                    ;% cjyyyt0pe2y.fxgka2mnesn.pbmosatjwq
                    section.data(10).logicalSrcIdx = 77;
                    section.data(10).dtTransOffset = 9;

                    ;% cjyyyt0pe2y.fxgka2mnesn.mbqww2f2j5
                    section.data(11).logicalSrcIdx = 78;
                    section.data(11).dtTransOffset = 10;

                    ;% cjyyyt0pe2y.fxgka2mnesn.axp3ltd2zv
                    section.data(12).logicalSrcIdx = 79;
                    section.data(12).dtTransOffset = 11;

                    ;% cjyyyt0pe2y.fxgka2mnesn.l1blgawhwv
                    section.data(13).logicalSrcIdx = 80;
                    section.data(13).dtTransOffset = 12;

                    ;% cjyyyt0pe2y.fxgka2mnesn.m2kjsqs5qx
                    section.data(14).logicalSrcIdx = 81;
                    section.data(14).dtTransOffset = 13;

                    ;% cjyyyt0pe2y.fxgka2mnesn.lwz1y2sst5
                    section.data(15).logicalSrcIdx = 82;
                    section.data(15).dtTransOffset = 14;

                    ;% cjyyyt0pe2y.fxgka2mnesn.lrr2wtcj40
                    section.data(16).logicalSrcIdx = 83;
                    section.data(16).dtTransOffset = 15;

                    ;% cjyyyt0pe2y.fxgka2mnesn.fydkhoc5nl
                    section.data(17).logicalSrcIdx = 84;
                    section.data(17).dtTransOffset = 16;

                    ;% cjyyyt0pe2y.fxgka2mnesn.ccpjbkpnaa
                    section.data(18).logicalSrcIdx = 85;
                    section.data(18).dtTransOffset = 17;

                    ;% cjyyyt0pe2y.fxgka2mnesn.lzffnlwupf
                    section.data(19).logicalSrcIdx = 86;
                    section.data(19).dtTransOffset = 18;

                    ;% cjyyyt0pe2y.fxgka2mnesn.pw3nshxesh
                    section.data(20).logicalSrcIdx = 87;
                    section.data(20).dtTransOffset = 19;

                    ;% cjyyyt0pe2y.fxgka2mnesn.ksoonylwpe
    ...
    targMap.checksum0 = 507654460;
    targMap.checksum1 = 4253240601;
    targMap.checksum2 = 2385929780;
    targMap.checksum3 = 3659868048;
