    ...
    ;%***********************
        ...
        ;%
            ...
            section.data(4)  = dumData; %prealloc
                    ...
                    ;% dexojrsdjj.Centery_Value
                    section.data(1).logicalSrcIdx = 1;
                    section.data(1).dtTransOffset = 0;

                    ;% dexojrsdjj.Inversion_Gain
                    section.data(2).logicalSrcIdx = 2;
                    section.data(2).dtTransOffset = 1;

                    ;% dexojrsdjj.Centerx_Value
            ...
            section.data(11)  = dumData; %prealloc
                    ...
                    ;% dexojrsdjj.fxgka2mnesn.SliderX_gain
                    section.data(10).logicalSrcIdx = 14;
                    section.data(10).dtTransOffset = 9;

                    ;% dexojrsdjj.fxgka2mnesn.SliderY_gain
    ...
    ;%**************************
        ...
        ;%
            ...
            section.data(3)  = dumData; %prealloc
                    ...
                    ;% ntrh2fpvwnc.hv05dl41ud
                    section.data(1).logicalSrcIdx = 0;
                    section.data(1).dtTransOffset = 0;

                    ;% ntrh2fpvwnc.eaty1yaxc2
                    section.data(2).logicalSrcIdx = 1;
                    section.data(2).dtTransOffset = 2;

                    ;% ntrh2fpvwnc.o4agjcnjad
            ...
            section.data(10)  = dumData; %prealloc
                    ...
                    ;% ntrh2fpvwnc.fxgka2mnesn.kdhgnwcbfj
                    section.data(2).logicalSrcIdx = 8;
                    section.data(2).dtTransOffset = 1;

                    ;% ntrh2fpvwnc.fxgka2mnesn.mab2n1svj5
                    section.data(3).logicalSrcIdx = 9;
                    section.data(3).dtTransOffset = 2;

                    ;% ntrh2fpvwnc.fxgka2mnesn.l5yugy1lyx
                    ...
                    ;% ntrh2fpvwnc.fxgka2mnesn.hb3rxou1qf
                    section.data(8).logicalSrcIdx = 18;
                    section.data(8).dtTransOffset = 11;

                    ;% ntrh2fpvwnc.fxgka2mnesn.ibhyeois2a
                    section.data(9).logicalSrcIdx = 19;
                    section.data(9).dtTransOffset = 12;

                    ;% ntrh2fpvwnc.fxgka2mnesn.lotqifrwes
    ...
    ;%*******************
        ...
        ;%
            ...
            section.data(1)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.nv1pn5idn0
            ...
            section.data(9)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.mlurq3sxkm
                    section.data(5).logicalSrcIdx = 14;
                    section.data(5).dtTransOffset = 7;

                    ;% cjyyyt0pe2y.fxgka2mnesn.ptq5ibv5aj
                    section.data(6).logicalSrcIdx = 15;
                    section.data(6).dtTransOffset = 8;

                    ;% cjyyyt0pe2y.fxgka2mnesn.gkzobqx1vx
                    section.data(7).logicalSrcIdx = 16;
                    section.data(7).dtTransOffset = 9;

                    ;% cjyyyt0pe2y.fxgka2mnesn.kg1kghli3a
                    section.data(8).logicalSrcIdx = 17;
                    section.data(8).dtTransOffset = 10;

                    ;% cjyyyt0pe2y.fxgka2mnesn.dfrifcvgzo
            ...
            section.data(4)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.i3olp3q5xr
            ...
            section.data(18)  = dumData; %prealloc
                    ...
                    ;% cjyyyt0pe2y.fxgka2mnesn.faikbl4lc5
                    section.data(7).logicalSrcIdx = 70;
                    section.data(7).dtTransOffset = 6;

                    ;% cjyyyt0pe2y.fxgka2mnesn.fwkvqtm55m
                    section.data(8).logicalSrcIdx = 71;
                    section.data(8).dtTransOffset = 7;

                    ;% cjyyyt0pe2y.fxgka2mnesn.ibsi5ihhaa
                    section.data(9).logicalSrcIdx = 72;
                    section.data(9).dtTransOffset = 8;

                    ;% cjyyyt0pe2y.fxgka2mnesn.f4rnf3qyer
                    section.data(10).logicalSrcIdx = 73;
                    section.data(10).dtTransOffset = 9;

                    ;% cjyyyt0pe2y.fxgka2mnesn.hdfopmne0g
                    section.data(11).logicalSrcIdx = 74;
                    section.data(11).dtTransOffset = 10;

                    ;% cjyyyt0pe2y.fxgka2mnesn.ljrt3us3qq
                    section.data(12).logicalSrcIdx = 75;
                    section.data(12).dtTransOffset = 11;

                    ;% cjyyyt0pe2y.fxgka2mnesn.kckdlkt5wc
    ...
    targMap.checksum0 = 1451297965;
    targMap.checksum1 = 3314958050;
    targMap.checksum2 = 1303020466;
    targMap.checksum3 = 214538386;
